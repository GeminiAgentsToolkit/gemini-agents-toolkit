...
class Pipeline(object):
    def __init__(self, *, default_agent=None, logger=None, use_convert_to_bool_agent=False, use_convert_agent_helper=False, debug=False):
        ...
        if use_convert_agent_helper or use_convert_to_bool_agent:
            self.convert_agent = agent_toolkit.create_agent_from_functions_list(model_name=SIMPLE_MODEL, system_instruction=CONVERT_BOT_SYSTEM_INSTRUCTIONS)
    ...
    def summarize_full_history(self, *, agent=None):
        ...
        # print(str(self._full_history))
        # print(str(self.convert_agent.per_model_tokens.update(self.agent.per_model_tokens)))
        # print(str(self.convert_agent.per_model_tokens))
