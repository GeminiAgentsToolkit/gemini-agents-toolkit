...
from gemini_agents_toolkit.stateless_agent import create_agent_from_functions_list
...
investor_agent = create_agent_from_functions_list(functions=all_functions,
