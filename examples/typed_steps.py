...
msg_, _ = pipeline.float_step("60 - 5% is?")

print(msg_)

msg_, _ = pipeline.int_step("60 - 5?")

print(msg_)

msg_, _ = pipeline.char_step("first character of the world 'hello' is?")

print(msg_)

msg_, _ = pipeline.string_array_step("sort words(by alphabet): 'my', 'hello', 'pen'")
