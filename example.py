...
clt = client.generate_chat_client_from_functions_list(all_functions, model_name="gemini-1.5-pro", debug=True, recreate_client_each_time=False, history_depth=3, add_scheduling_functions=True)
